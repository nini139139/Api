    ...
    public partial class CreateNew : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarketCompanies", x => new { x.Company, x.Market });
                    table.ForeignKey(
                        name: "FK_MarketCompanies_Companies_Company",
                        column: x => x.Company,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MarketCompanies_Markets_Market",
                        column: x => x.Market,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarketCompanies_Market",
